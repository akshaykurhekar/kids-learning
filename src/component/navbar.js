...
function Navbarkids() {
  return (
    ...
    <Navbar expand="lg">
    <Navbar.Brand href="/kids-learning/#/"><h1>KG E-Book</h1> </Navbar.Brand>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="mr-auto">
        ...
        <Nav.Link href="/kids-learning/#/about"><img src="https://img.icons8.com/color/26/000000/about.png" alt="About_icon"/> About </Nav.Link>
